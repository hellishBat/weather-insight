  ...
  const highlightsData = [
    {
      ...
      color: 'text-amber-400/75 dark:text-amber-200 ',
    },
    {
      ...
      color: 'text-sky-400/75 dark:text-sky-200 ',
    },
    {
      ...
      color: 'text-cyan-400/75 dark:text-cyan-200 ',
    },
    {
      ...
      color: 'text-red-400/75 dark:text-red-200',
    },
    {
      ...
      color: 'text-blue-400/75 dark:text-blue-200 ',
    },
    {
      ...
      color: 'text-indigo-400/75 dark:text-indigo-200 ',
    },
  ]

  return (
    <div className="flex gap-6 flex-wrap mb-12 sm:gap-8 md:flex-nowrap">
